defmodule Cassandra.Ecto.Adapter do
  ...
  defp timestamp_encode({{y, m, d}, {h, i, s, usec}}), do:
    {:ok, %DateTime{calendar: Calendar.ISO, day: d, hour: h, microsecond: {usec, 3}, minute: i, second: s, std_offset: 0, month: m, time_zone: "Etc/UTC", utc_offset: 0, year: y, zone_abbr: "UTC"} |> DateTime.to_unix(:millisecond)}
